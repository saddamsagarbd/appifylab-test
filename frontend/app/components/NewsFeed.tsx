...
const NewsFeed = ({ post, userId }: NewsFeedProps) => {
    ...
    const toggleLikePost = async (postId: number) => {
        const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/posts/toggle-like`, { postId, userId });
        ...
        <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
                ...
                <div className="_feed_inner_timeline_post_top">
                    <div className="_feed_inner_timeline_post_box">
                        <div className="_feed_inner_timeline_post_box_image">
                            ...
                            <Image src="/assets/images/post_img.png" fill alt="" className="_post_img" />
                            </div>
                        </div>
                        <div className="_feed_inner_timeline_post_box_txt">
                            <h4 className="_feed_inner_timeline_post_box_title">{post.first_name} {post.last_name}</h4>
                            <p className="_feed_inner_timeline_post_box_para">{timeAgo(post.created_at)} . 
                                <Link href="#">{post.visibility ? "Public" : "Private"}</Link>
                            </p>
                        </div>
                    </div>
                    <div className="_feed_inner_timeline_post_box_dropdown">
                        <div className="_feed_timeline_post_dropdown">
                            <Link href="#">
                                <button id="_timeline_show_drop_btn" className="_feed_timeline_post_dropdown_link" aria-label="Switch layout">
            ...
            <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
                <div className="_feed_inner_timeline_total_reacts_image">
                    <div className="image-wrapper">
                    <Image src="/assets/images/react_img1.png" fill alt="Image" className="_react_img1" />
                    </div>
                    <div className="image-wrapper">
                    <Image src="/assets/images/react_img2.png" fill alt="Image" className="_react_img" />
                    </div>
                    <div className="image-wrapper">
                    <Image src="/assets/images/react_img3.png" fill alt="Image" className="_react_img _rect_img_mbl_none" />
                    </div>
                    <div className="image-wrapper">
                    <Image src="/assets/images/react_img4.png" fill alt="Image" className="_react_img _rect_img_mbl_none" />
                    </div>
                    <div className="image-wrapper">
                    <Image src="/assets/images/react_img5.png" fill alt="Image" className="_react_img _rect_img_mbl_none" />
                    </div>
                    <p className="_feed_inner_timeline_total_reacts_para">9+</p>
                </div>
                <div className="_feed_inner_timeline_total_reacts_txt">
                    <p className="_feed_inner_timeline_total_reacts_para1">
                        <Link href="#"><span>12</span> Comment</Link>
                    </p>
                    <p className="_feed_inner_timeline_total_reacts_para2"><span>122</span> Share</p>
                </div>
            </div>
            <div className="_feed_inner_timeline_reaction">
                <button onClick={() => toggleLikePost(post.id)} className="_feed_inner_timeline_reaction_emoji _feed_reaction _feed_reaction_active">
                ...
                <div className="_feed_inner_comment_box">
                    <form className="_feed_inner_comment_box_form">
                        ...
                        <div className="_feed_inner_comment_box_icon">
                            <button className="_feed_inner_comment_box_icon_btn" aria-label="Switch layout">
                    ...
                    <div className="_comment_main">
                        <div className="_comment_image">
                            <Link href="#" className="_comment_image_link">
                                <div className="image-wrapper">
                                    <Image src="/assets/images/txt_img.png" fill alt="" className="_comment_img1" />
                                </div>
                            </Link>
                        </div>
